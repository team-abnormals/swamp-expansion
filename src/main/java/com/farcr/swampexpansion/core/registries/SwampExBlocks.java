...
public class SwampExBlocks {
	...
	public static RegistryObject<Block> POTTED_CATTIL		    = RegistryUtils.createBlockNoItem("potted_cattail",		() -> new FlowerPotBlock(CATTAIL.get(), Block.Properties.from(Blocks.POTTED_POPPY)));
