...
public class SwampExFoods {
	...
	public static Food RICE_BALL 			= new Food.Builder().hunger(2).saturation(0.2F).build(); //temporary
	...
	public static Food SQUID_INK_RISOTTO 	= new Food.Builder().hunger(2).saturation(0.2F).build(); //temporary
}
