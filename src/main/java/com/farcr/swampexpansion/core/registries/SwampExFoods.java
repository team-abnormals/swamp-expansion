...
public class SwampExFoods {
	...
	public static Food SALMON_RICE_CAKE 	= new Food.Builder().hunger(4).saturation(0.7F).fastToEat().build(); //0.67
	public static Food PUFFERFISH_RICE_CAKE = new Food.Builder().hunger(4).saturation(0.3F).fastToEat().effect(new EffectInstance(Effects.WEAKNESS, 600), 1.0F).build(); //0.25
	public static Food LIONFISH_RICE_CAKE 	= new Food.Builder().hunger(3).saturation(0.9F).fastToEat().effect(new EffectInstance(Effects.SLOWNESS, 600), 1.0F).build(); //0.90
