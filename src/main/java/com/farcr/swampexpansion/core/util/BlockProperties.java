...
public class BlockProperties {
    ...
    public static Block.Properties CATTAIL = Block.Properties.create(Material.TALL_PLANTS).hardnessAndResistance(0.0F).doesNotBlockMovement().sound(SoundType.PLANT);
}