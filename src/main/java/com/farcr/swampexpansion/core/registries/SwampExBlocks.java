...
public class SwampExBlocks {
	...
	public static RegistryObject<Block> MUD_BRICK_VERTICAL_SLAB = RegistryUtils.createBlockCompat("quark", "mud_brick_vertical_slab", () -> new VerticalSlabBlock(BlockProperties.MUD_BRICKS), ItemGroup.BUILDING_BLOCKS);
	...
	public static RegistryObject<Block> WILLOW_VERTICAL_SLAB 	= RegistryUtils.createBlockCompat("quark", "willow_vertical_slab", () -> new VerticalSlabBlock(BlockProperties.WILLOW_PLANKS), ItemGroup.BUILDING_BLOCKS);
	...
	public static RegistryObject<Block> WILLOW_LEAF_CARPET 		= RegistryUtils.createBlockCompat("quark", "willow_leaf_carpet", () -> new LeafCarpetBlock(BlockProperties.LEAVES.notSolid()), ItemGroup.DECORATIONS);
	...
	public static RegistryObject<Block> CATTAIL_THATCH          = RegistryUtils.createBlock("cattail_thatch", () -> new Block(Properties.from(Blocks.HAY_BLOCK).harvestTool(ToolType.AXE)), ItemGroup.BUILDING_BLOCKS);
