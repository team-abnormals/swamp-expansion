...
// */
//public class AxolotlModel<T extends AxolotlEntity, E> extends AgeableModel<T> {
...
//        this.RightFrontLeg.render(matrixStack, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
...
//        this.LeftbackLeg.render(matrixStack, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
//        this.Body.render(matrixStack, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
//        this.LeftFrontLeg.render(matrixStack, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
//        this.RightBackLeg.render(matrixStack, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
//    }
//
