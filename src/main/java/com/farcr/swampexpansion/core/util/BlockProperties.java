...
public class BlockProperties {
    ...
    public static Block.Properties LADDER = Block.Properties.create(Material.MISCELLANEOUS).harvestTool(ToolType.AXE).hardnessAndResistance(0.4F).sound(SoundType.LADDER);
