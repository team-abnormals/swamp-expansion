...
public class WillowBoatEntity extends BoatEntity {
   ...
   public WillowBoatEntity(EntityType<? extends WillowBoatEntity> p_i50129_1_, World p_i50129_2_) {
      super(p_i50129_1_, p_i50129_2_);
      this.preventEntitySpawning = true;
   }

   public WillowBoatEntity(World worldIn, double x, double y, double z) {
      this(SwampExEntities.BOAT.get(), worldIn);
   ...
   protected void registerData() {
      ...
      this.dataManager.register(BOAT_TYPE, WillowBoatEntity.Type.WILLOW.ordinal());
   ...
   protected void readAdditional(CompoundNBT compound) {
      if (compound.contains("Type", 8)) {
         this.setBoatType(WillowBoatEntity.Type.getTypeFromString(compound.getString("Type")));
      }
   ...
   public void setBoatType(WillowBoatEntity.Type boatType) {
      this.dataManager.set(BOAT_TYPE, boatType.ordinal());
   }

   public WillowBoatEntity.Type getBoatModel() {
      return WillowBoatEntity.Type.byId(this.dataManager.get(BOAT_TYPE));
   }
   ...
   public static enum Type {
       ...
       */
      public static WillowBoatEntity.Type byId(int id) {
    	  WillowBoatEntity.Type[] aboatentity$type = values();
      ...
      public static WillowBoatEntity.Type getTypeFromString(String nameIn) {
    	  WillowBoatEntity.Type[] aboatentity$type = values();
