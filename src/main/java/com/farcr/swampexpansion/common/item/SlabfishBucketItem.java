	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		if (compoundnbt != null) {
			...
			if (compoundnbt.contains("HasBackpack") && compoundnbt.getBoolean("HasBackpack") && compoundnbt.contains("BackpackColor", 99)) {
				...
				TextFormatting[] atextformatting = new TextFormatting[] {TextFormatting.ITALIC, TextFormatting.GRAY};
				tooltip.add((new TranslationTextComponent("entity.swampexpansion.slabfish." + DyeColor.byId(i).getTranslationKey() + "_backpack").applyTextStyles(atextformatting)));
			}
			if (compoundnbt.contains("HasSweater") && compoundnbt.getBoolean("HasSweater")  && compoundnbt.contains("SweaterColor", 99)) {
				...
				TextFormatting[] atextformatting = new TextFormatting[] {TextFormatting.ITALIC, TextFormatting.GRAY};
				tooltip.add((new TranslationTextComponent("entity.swampexpansion.slabfish." + DyeColor.byId(i).getTranslationKey() + "_sweater").applyTextStyles(atextformatting)));
			}
		}
	}
}