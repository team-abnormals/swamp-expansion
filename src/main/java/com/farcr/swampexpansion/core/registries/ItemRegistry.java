...
public class ItemRegistry {
	...
	public static Item MUD_BRICK = new Item(new Item.Properties().group(ItemGroup.MATERIALS));
	public static Item WILLOW_SIGN = new SignItem(new Item.Properties().group(ItemGroup.DECORATIONS), BlockRegistry.WILLOW_SIGN, BlockRegistry.WILLOW_SIGN_WALL);
	public static Item MUD_BUCKET = new BucketItem(BlockRegistry.MUD, new Item.Properties().group(ItemGroup.MISC));
