...
public final class MarshBiome extends Biome {
	   public MarshBiome() {
	      super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.SWAMP, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG).precipitation(Biome.RainType.RAIN).category(Biome.Category.SWAMP).depth(-0.1F).scale(0.03F).temperature(0.8F).downfall(0.9F).waterColor(6384484).waterFogColor(2302743).parent((String)null));
	      ...
	      SwampExBiomeFeatures.addCattails(this);
	   ...
	   public int getGrassColor(double posX, double posZ) {
	      ...
	      return d0 < -0.1D ? 6653508 : 5468214;
	   }
